    ...
    <section className="bg-blue-300 py-10">
      <div className="container py-8 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="max-w-screen-md mb-8 lg:mb-16">
          <h2 className="mb-4 text-2xl md:text-4xl tracking-tight font-extrabold text-black">
            Nos Services
          </h2>
          <p className="text-black sm:text-xl font-arimo">
            Découvrez les services que nous offrons pour répondre à vos besoins
            en matière de télécommunications.
          </p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="rounded-lg p-6 shadow-lg border border-black hover:bg-black hover:text-white hover:cursor-pointer transition-colors duration-700">
