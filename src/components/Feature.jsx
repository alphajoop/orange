    ...
    <section className="bg-white py-10 dark:bg-gray-900 transform duration-700">
      <div className="container py-8 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="max-w-screen-md mb-8 lg:mb-16">
          <h2 className="mb-4 text-2xl md:text-4xl tracking-tight font-extrabold text-orange-200 dark:text-orange-100">
            Pourquoi choisir Orange ?
          </h2>
          <p className="text-black sm:text-xl dark:text-white font-arimo">
